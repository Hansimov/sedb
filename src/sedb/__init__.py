...
_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "PostgresOperator": ("sedb.postgres", "PostgresOperator"),
    "PostgresConfigsType": ("sedb.postgres", "PostgresConfigsType"),
    "postgres_dsn": ("sedb.postgres", "postgres_dsn"),
    "normalize_postgres_configs": ("sedb.postgres", "normalize_postgres_configs"),
